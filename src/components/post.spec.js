...
describe('addPost', () => {
  ...
  //     const id = '3JsPYcgxt57rtirxC3KM';
  //     addPost().querySelector(`#btn-like-${id}`).dispatchEvent(new Event('click'));
  //     expect(services.likePost).toHaveBeenCalled();
  //   });

//   it('click on the Button dislike', () => {
//     const id = '3JsPYcgxt57rtirxC3KM';
//     addPost().querySelector(`#btn-dislike-${id}`).dispatchEvent(new Event('click'));
